...
/**
 * FirstSemesterSearch represents the model behind the search form of `app\modules\StudentInformation\models\FirstSemester`.
 */
class FirstSemesterSearch extends FirstSemester
{
    /**
     * {@inheritdoc}
     */
