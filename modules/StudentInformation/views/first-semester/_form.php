...
<div class="row">
<div class="col col-sm-6 col-lg-6">
    <?= $form->field($model, 'department')->dropDownList(ArrayHelper::map(app\modules\configuration\models\Department::find()->all(), 'department_id', 'department_name'), ['prompt'=> 'Select Departement']) ?>
</div>
<div class="col col-sm-6 col-lg-6">
